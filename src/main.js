  ...
  app.innerHTML = `
    <header class="glass" style="padding: 1rem 2rem; border-radius: var(--radius-lg); margin-bottom: 2rem; display: flex; justify-content: space-between; align-items: center; background: rgba(20, 30, 60, 0.6); position: relative; z-index: 1000;">
      ...
      <div style="display: flex; align-items: center; gap: 1rem;">
        ...
        <button id="settings-btn" class="glass icon-btn" style="position: relative; background: rgba(255, 255, 255, 0.08); border: 1px solid rgba(255, 255, 255, 0.15); box-shadow: 0 4px 10px rgba(0,0,0,0.2); padding: 0.5rem; border-radius: 50%; cursor: pointer; transition: all 0.2s ease; margin-left: 0.5rem;" title="Settings">
